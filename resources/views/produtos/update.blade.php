              ...
              <div class="panel-body">
                <div class="form">
                  ...
                  @csrf
                    ...
                    <div class="form-group ">
                        <label for="preco" class="control-label col-lg-2">Quantidade em estoque <span>*</span></label>
                        <div class="col-lg-10">
                          <input class="form-control " id="qtd" type="number" name="qtd" value="{{ $p->qtd }}" />
                        </div>
                      </div>
                      <div class="form-group ">
                        <label for="preco" class="control-label col-lg-2">Data de Validade <span>*</span></label>
                        <div class="col-lg-10">
                          <input class="form-control " id="validade" type="text" name="validade" value="{{$p->validade }}" />
                        </div>
                      </div>
                    <div class="form-group">
