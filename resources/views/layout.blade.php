...
<section id="container" class="">
    <header class="header dark-bg">
        ...
        <a href="#" class="logo">Demeter</span></a>
    ...
    <aside>
        <div id="sidebar" class="nav-collapse ">
            ...
            <ul class="sub">
                ...
                <li><a href="{{ route('listar_usuarios') }}"><i class="fa fa-user"></i><span>Usuarios</span></a></li>
                <li><a href="{{ route('listar_vendas') }}"><i class="fa fa-cart-arrow-down"></i><span>Vendas</span></a></li>
                <li><a href="{{ route('listar_clientes') }}"><i class="fa fa-users"></i><span>Clientes</span></a></li>
            </ul>
          </li>
            </ul>
        </div>
